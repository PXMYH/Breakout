...
/** Number of turns */
	...
	private GObject getCollidingObject() {
		if (getElementAt(ball.getX() + BALL_RADIUS, ball.getY()) == null) 				// ball upper tip
			
			if(getElementAt(ball.getX() + BALL_RADIUS, ball.getY() + BALL_RADIUS * 2) == null)		// right upper corner
